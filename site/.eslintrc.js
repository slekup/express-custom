...
module.exports = {
  ...
  extends: [
    ...
    'next/core-web-vitals', // Next.js base rules + stricter core web vitals rule-set
  ...
  rules: {
    ...
    '@typescript-eslint/explicit-function-return-type': 0, // Enforces return type declaration of functions.
    ...
    'no-console': 0, // Disallows specified syntax
    'no-alert': 0, // Disallows specified syntax
  },
  settings: {
    'import/resolver': {
      typescript: {
