export type StringTest = 'email' | 'username' | 'passwordStrength' | 'phoneNumber' | 'ipAddress' | 'url' | 'path';
export type SchemaOption = string | number | boolean | null | undefined;
export type SchemaTypes = string | number | boolean | unknown[] | object | null | undefined | unknown;
export type ValueTypes = 'string' | 'number' | 'integer' | 'boolean' | 'object' | 'array' | 'image';
...
export type ValueSchema = IArrayValue<ValueSchema> | IBooleanValue | IImageValue | INumberValue | IIntegerValue | IObjectValue<Record<string, ValueSchema>> | IStringValue;
