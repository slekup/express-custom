...
exports.default = async (fileName) => {
    ...
    try {
        ...
        logger_1.default.info(`${logger_1.cli.info} Loading tsconfig.json`);
        ...
        try {
            ...
            logger_1.default.error(`${logger_1.cli.error} Failed to load tsconfig.json file. If it exists, make sure it is valid JSON: ${colors_1.default.cyan('https://jsonlint.com/')}.`);
            process.exit(1);
        }
        if (!tsconfigJson.compilerOptions) {
            logger_1.default.error(`${logger_1.cli.error} Failed to load tsconfig.json file, no compilerOptions.`);
            process.exit(1);
        }
        const baseUrl = tsconfigJson.compilerOptions.baseUrl ?? '.';
        const paths = tsconfigJson.compilerOptions.paths ?? {};
        logger_1.default.info(`${logger_1.cli.info} Compiling TypeScript`);
        ...
        logger_1.default.info(`${logger_1.cli.info} Registering tsconfig paths`);
        ...
        logger_1.default.info(`${logger_1.cli.info} Loading API file`);
        ...
        logger_1.default.info(`${logger_1.cli.success} ⚡ Loaded API file in ${time}`);
        // Access the exported API
        if (!module.default) {
            logger_1.default.error(`${logger_1.cli.error} Failed to load the API file, no default export.`);
            process.exit(1);
        }
        ...
        logger_1.default.error(`${logger_1.cli.error} Failed to load the API file, you have errors in your code!`);
