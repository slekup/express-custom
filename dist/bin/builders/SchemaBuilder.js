...
class SchemaBuilder {
     ...
     */
    addArray(callback) {
        const value = new Value_1.ArrayValueBuilder();
        callback(value);
     ...
     */
    addString(callback) {
        const value = new Value_1.StringValueBuilder();
        callback(value);
        this.schema[value.name] = value;
        return this;
    }
     ...
     */
    addNumber(callback) {
        const value = new Value_1.NumberValueBuilder();
        callback(value);
        this.schema[value.name] = value;
        return this;
    }
     ...
     */
    addInteger(callback) {
        const value = new Value_1.IntegerValueBuilder();
        callback(value);
        this.schema[value.name] = value;
        return this;
    }
     ...
     */
    addBoolean(callback) {
        const value = new Value_1.BooleanValueBuilder();
        callback(value);
        this.schema[value.name] = value;
        return this;
    }
     ...
     */
    addObject(callback) {
        const value = new Value_1.ObjectValueBuilder();
        callback(value);
        this.schema[value.name] = value;
        return this;
    }
     ...
     */
    addImage(callback) {
        const value = new Value_1.ImageValueBuilder();
        callback(value);
        this.schema[value.name] = value;
        return this;
    }
